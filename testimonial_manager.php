...
class TestimonialOptions {
    ...
    function on_admin_menu() {
        ...
        add_object_page('Testimonial Manager', "Testimonials", - 1, "testimonials", array(&$this, 'on_show_page'));
    ...
    function on_setting_page() {
        ...
        ?>
        <div class="wrap">
            <h2><?php echo __('Testimonial Manager Settings'); ?></h2>
            <div class="bordertitle"></div>
            <br/>
            <?php
            if (isset($_GET['msg'])) { ?>
    ...
    function on_save_changes() {
        ...
        if (isset($_POST['CreateTestimonial'])) {
            ...
            $inputdata['title']     = stripslashes($_POST['title']);
            $inputdata['company_name'] = stripslashes($_POST['company_name']);
    ...
    ?>
        ...
        <table border="0" width="100%" cellspacing="20">
            ...
            <tr>
                ...
                <td width="84%">
                    <input type="text" name="title" value="<?php if ($_GET['action'] == 'edit') { echo $test['title']; } ?>" style="width:100%;" />
                </td>
            </tr>
            <tr>
                <td width="16%" align="right" valign="top" >
                ...
                <td width="84%">
                    <input type="text" name="company_name" value="<?php if ($_GET['action'] == 'edit') { echo $test['company_name']; } ?>" style="width:100%;" />
                </td>
            </tr>
            <tr>
                <td width="16%" align="right" valign="top" >
    ...
    function plugininfo() {?>
        <table width="100%" border="0" cellspacing="4">
            <tr>
                ...
                <td valign="top">Testimonials Manager</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td valign="top"> Gobala Krishnan</td>
            </tr>
            <tr>
